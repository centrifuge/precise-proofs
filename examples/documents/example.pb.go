...
func init() {
	proto.RegisterType((*ExampleDocument)(nil), "examples.ExampleDocument")
	proto.RegisterType((*LongDocument)(nil), "examples.LongDocument")
	proto.RegisterType((*SaltedLongDocument)(nil), "examples.SaltedLongDocument")
	proto.RegisterType((*SaltedExampleDocument)(nil), "examples.SaltedExampleDocument")
}

func init() { proto.RegisterFile("examples.proto", fileDescriptor0) }
